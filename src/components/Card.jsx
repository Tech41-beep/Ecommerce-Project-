...
function Card() {
  return (
     <Link to="/products/1" className=" bg-gray-50  px-4 mt-[80px]">
      {/* Header */}
      ...
      <div className="text-center mt-16">
        <button className="px-4 py-3 rounded-xl bg-green-600 text-black font-semibold hover:bg-green-700 transition shadow">
          Load More Products
        </button>
      </div>
    </Link>
